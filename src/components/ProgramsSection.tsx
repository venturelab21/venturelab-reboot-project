      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <Program 
            title="SISFS" 
            label="Open"
            description="The Startup India Seed Fund Scheme, backed by DPIIT, is designed to catalyze early-stage innovation by providing strategic investment to startups — enabling them to validate concepts, develop prototypes, run product trials, and accelerate market entry and commercialization. Seed funding to startups for proof of concept, prototype development, product trials, market entry, and commercialization."
