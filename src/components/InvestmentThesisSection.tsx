...
const InvestmentThesisSection = () => {
  const investmentAreas = [
    ...
    {
      title: "B2B SaaS",
      description: "Empowering businesses with scalable software solutions, automation, and productivity tools",
      tagline: "Business Enhanced",
    ...
    <section className="py-24 bg-gradient-to-br from-slate-50 via-white to-blue-50" id="investment-thesis">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-20 text-center">
          ...
          {/* Updated text without color highlighting */}
