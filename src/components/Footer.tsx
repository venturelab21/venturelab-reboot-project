    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-display font-semibold mb-4">VentureLab</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/programs#pre-incubation" className="text-gray-300 hover:text-white">Pre-Incubation</Link></li>
              <li><Link to="/programs#incubation" className="text-gray-300 hover:text-white">Incubation</Link></li>
              <li><Link to="/programs#acceleration" className="text-gray-300 hover:text-white">Acceleration</Link></li>
              <li><Link to="/programs#investment" className="text-gray-300 hover:text-white">Investment</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <address className="not-italic text-gray-300">
              ...
              <p>Phone: <a href="tel:+919876543210" className="hover:text-white">+91 987 654 3210</a></p>
            </address>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; {new Date().getFullYear()} VentureLab. All rights reserved.
            </p>
